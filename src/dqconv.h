...
inline void quatTrans2UDQ(const glm::quat &q0, const ci::vec3 &t, glm::quat dq[2] )
{
...
inline void UDQ2QuatTrans( const glm::quat dq[2],
						   glm::quat &q0, ci::vec3 &t)
{
...
// output: unit quaternion 'q0', translation vector 't'
inline void DQ2QuatTrans( const glm::quat dq[2], glm::quat &q0, ci::vec3 &t)
{
	float len = 0.0;
